...
sizes of the files it contains, directly or indirectly. (Directories themselves do
not count as having any intrinsic size.)
...
you need unused space of at least 30000000. You need to find a directory you can delete 
...
total amount of used space) is 48381165; 
